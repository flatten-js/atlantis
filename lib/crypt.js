...
exports.encrypt = (algorithm, key) => (new SUPPORT_ALGORITHM[algorithm](key)).encrypt
exports.decrypt = (algorithm, key, total) => (new SUPPORT_ALGORITHM[algorithm](key)).decrypt(total)
